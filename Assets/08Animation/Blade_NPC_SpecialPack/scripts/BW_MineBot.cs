...
public class BW_MineBot: MonoBehaviour {
	...
	static int jumpState = Animator.StringToHash("Base Layer.BW_Jump_Front");
	static int attack01State = Animator.StringToHash("Base Layer.BW_Attack01");
