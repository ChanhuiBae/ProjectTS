...
public class BG_C_MineBot: MonoBehaviour {
	...
	static int jumpState = Animator.StringToHash("Base Layer.BG_Chibi_Jump_Front");
	static int attack01State = Animator.StringToHash("Base Layer.BG_Chibi_Attack01");
